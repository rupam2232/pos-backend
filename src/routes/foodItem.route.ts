...
import { createFoodItem, getAllFoodItemsOfRestaurant, getFoodItemById } from "../controllers/foodItem.controller.js";
...
.post(isProduction ? createLimit : (req, res, next) => next(), verifyAuth, isSubscriptionActive, createFoodItem)
.get(getAllFoodItemsOfRestaurant)

router.route("/:restaurantSlug/:foodItemId")
.get(getFoodItemById)
